 ...
 */
export function clone(object, options = {
    ...
    const main = function main(node) {
        if (typeof node === "function") {
            ...
            throw Object.assign(new TypeError("Cannot clone a function."), { path: [...path] });
        }
        ...
        for (const key of keys) {
            ...
            if ("value" in descriptor) {
                ...
                throw Object.assign(new TypeError("Cannot clone property accessors."), { path: [...path] });
            }
 ...
 * @returns {NonPrimitive}
 */
export function copy(object, options = {
    "ignoreAttributes": false,
    "ignoreExtensibility": false,
    "ignoreSymbols": false,
}) {
    ...
    const propertyKeys = (ignoreSymbols
...
const customInspect = function custom(depth, options) {
    void depth;
    return options.stylize(`[Object <${Object.keys(this).length}>]`, "special");
};
...
export function defineCheckedProperty(object, key, predicate) {
    ...
    Object.defineProperty(object, key, {
        ...
        "set"(arg) {
            if (!predicate(arg)) {
                throw Object.assign(new TypeError("Bad property value."), { key, arg, predicate });
            }
            propertyValue = arg;
        },
        "enumerable": true,
...
export function getOwnPropertyDescriptorsByName(object) {
    ...
    for (const propertyName of ownPropertyNames) {
        rv[propertyName] = (Object.getOwnPropertyDescriptor(object, propertyName));
    }
    return rv;
}
 ...
 * @returns {PropertyKey[][]}
 */
export function getOwnPropertyPaths(object, options = { "ignoreSymbols": false }) {
    tc.expectNonPrimitive(object);
    tc.expectNonPrimitive(options);
    const ignoreSymbols = ("ignoreSymbols" in options
